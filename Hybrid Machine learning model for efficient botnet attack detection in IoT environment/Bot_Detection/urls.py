"""cyber_threat_sharing URL Configuration
...
from Bot_Detection_app import views
...
urlpatterns = [
    ...
    path('model_builder_login/',views.model_builder_login),
    path('model_builder_login_action/',views.model_builder_login_action),
    path('model_builder_home/',views.model_builder_home),
    path('preprocess/',views.preprocess),
    path('user_registration/',views.user_registration),
    path('user_login/',views.user_login),
    path('user_home/',views.user_home),
